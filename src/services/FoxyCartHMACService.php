...
namespace youandmedigital\foxycarthmac\services;
 ...
 * @example https://github.com/FoxyCart/FoxyCart-Cart-Validation--PHP
 *
 * Requirements:
...
class FoxyCartHMACService extends Component
{
    /**
     * API Key (Secret)
     *
     * @var string
     **/
    private static $secret = 'SECRET_API_KEY_GOES_HERE';
     ...
     **/
    protected static $cart_url = 'CART_LINK_GOES_HERE';
